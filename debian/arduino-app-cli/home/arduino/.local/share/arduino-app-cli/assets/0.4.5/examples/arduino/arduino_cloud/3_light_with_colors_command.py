...
from arduino.app_bricks.arduino_iot_cloud import ArduinoCloud, ColoredLight
...
while True:
    ...
    print(
        f"Light set to "
        f"hue: {arduino_cloud.clight.hue}, "
        f"saturation: {arduino_cloud.clight.sat}, "
        f"brightness: {arduino_cloud.clight.bri}"
    )
    time.sleep(3)
